#ifndef __HX_POLARSSL_MD2_HPP
#define __HX_POLARSSL_MD2_HPP
...
/*
 * Calculates the MD2 sum of the input bytes.
 *
 * See:
 *   https://polarssl.org/api/md2_8h.html
 *
 * Example:
 *   value sum = hx_md2(buffer_val(buf), buffer_size(buf));
 *
 * Parameters:
...
/*
 * Calculates the MD2 sum of the file specified by 'path'.
 *
 * See:
 *   https://polarssl.org/api/md2_8h.html
 *
 ...
 *
 * Example:
 *   value ret = hx_md2_self_test(alloc_bool(false));
 *   if (val_int(ret) == 0) {
 *       // everthing good
 *   }
 *
 ...
 */
value hx_md2_self_test(value verbose);

#ifdef __cplusplus
} // extern "C"
#endif

#endif /* __HX_POLARSSL_MD2_HPP */
